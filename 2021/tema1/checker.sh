...
# se ruleaza cele 5 teste pe varianta secventiala
...
run_and_get_time_seq "./skel/tema1 ./skel/inputs/in5 5 > test5_sec"
echo "OK"
echo ""
...
do
	...
	run_par ${times[4]} "./sol/tema1_par ./skel/inputs/in5 5 $P > test5_par"
	...
	compare_outputs test5_sec test5_par 0
